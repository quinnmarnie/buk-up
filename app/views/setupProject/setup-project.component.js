...
controller("setupProjectController", function($scope, $firebaseArray, $mdDialog, $mdMedia, $mdToast){
  var ref = firebase.database().ref().child("setupActivity");
  ...
  $scope.create = function(ev, setupProject){
    $mdDialog.show({
      controller: proponentDialogController,
...
function proponentDialogController($scope, $firebaseArray, $mdDialog, $mdToast, $timeout) {
  var ref = firebase.database().ref().child("setupActivity");
  $scope.setupActivity = $firebaseArray(ref);

  $scope.dialogTitle = "Add Proponent"

  $scope.submitProponent = function() {
    $scope.setupActivity.$add({
...
function editProponentController($scope, $firebaseArray, $mdDialog, setupProject) {
  ...
  $scope.submitProponent = function() {
    var record = $scope.setupActivity.$getRecord(setupProject.id);
    ...
    $scope.setupActivity.$save(record);
    $mdDialog.hide();
  }
